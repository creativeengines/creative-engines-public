...
This glossary defines recurring public terms used across Creative Engines materials. It is the public-safe subset of the canonical Creative Engines glossary – customer-facing meanings only, no internal codenames or methodology.
...
**Buyability** - How ready a brand is to be *bought*: recognised, trusted, and easy to say yes to. The B2B marketing industry's term, established by LinkedIn's B2B Institute with Bain & Company. It is the condition a [Reason to Buy](../concepts/reason-to-buy.md) produces: the reason is the asset a brand builds, buyability is what the brand gains once that reason is found, proven, and carried everywhere. See [buyability](../concepts/buyability.md).
...
**Content Pillar** - An ongoing, recurring content theme a brand publishes against continuously, mapped to the channels, formats, and weekly cadence it runs on.

**Ad Campaign** - A time-bound content motion organized around a specific objective, launch, or offer, with a defined start and end.

**Marketing Activity** - The parent of a Content Pillar and an Ad Campaign: a planned way to put a value proposition in front of an audience.

**Content grid** - The plan of which content themes run on which channel, in what format, and at what cadence.

**Content task** - The unit of content work, moving through stages from research to publishing, with an explicit review state at each step.
