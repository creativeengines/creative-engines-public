...
# The Methodology Base

Creative Engines is not a thin layer over a chat model. Its behavior is shaped by a curated base of marketing science and creative methodology, applied as working rules across audience understanding, strategy, attention planning, and production.

This page explains, at a safe level, what that base covers and how it is used. It does not publish the sources, formulas, catalogs, or models behind it.

## What the base draws on
