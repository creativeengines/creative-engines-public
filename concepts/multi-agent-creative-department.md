...
At a client-facing level, the department is easiest to understand through a few familiar roles:
...
The difference between Creative Engines and a single-pass tool is the difference between one answer and a process that argues with itself before committing:

- A generic tool produces a draft. The Creative Department produces, contests, and selects.
- A generic tool treats the first output as the answer. The Creative Department treats it as one candidate among many.
- A generic tool optimizes for a fluent sentence. The Creative Department optimizes for an asset that is on-strategy, on-voice, specific, and safe to publish.
