...
- **Segment by what a buyer is doing, not by headcount.** Splitting a market by company size is a false cut that shrinks it without improving fit: two agencies of the same headcount can be a small shop and a very large one. What predicts behaviour is the shape of the work – how many brands are carried at once, who is still personally signing off, where the work changes hands. Those are checkable, and they cut across org charts: a sophisticated in-house lead and an agency strategist with the same shape of work buy the same way.
